...
def get_combined_markdown_annotated(
    ocr_response: OCRResponse, annotations_response: str
) -> str:
    ...
    for page in ocr_response.pages:
        ...
        markdowns.append(
            replace_images_in_markdown_annotated(page.markdown, image_data)
        )
    return "\n\n".join(markdowns)


def convert_to_markdown(
    annotations_response: dict, ocr_response: OCRResponse, out_file: str
) -> str:
