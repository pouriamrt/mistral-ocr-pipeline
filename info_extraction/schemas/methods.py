...
class ExtractionMethods(BaseModel):
    ...
    doac_level_measurement: Optional[
        ...
        description=(
            ...
            "1) Use ONLY Methods and Results. IGNORE Introduction, Background, Abstract, Discussion, References, Acknowledgments.\n"
            ...
            "REQUIRED TWO-STEP EVIDENCE GATE (MANDATORY):\n"
            "Step 1 (Locate trigger sentence): Find at least one sentence in METHODS or RESULTS that uses "
            "EXPLICIT performance language showing the assay was ACTUALLY PERFORMED in THIS study on "
            "patient-derived samples. Mentions in Introduction, Background, Abstract, Discussion, "
            "References, or Acknowledgments are CONTEXTUAL ONLY and DO NOT qualify, even if a specific "
            "technique (HPLC-MS, anti-Xa, dTT, etc.) is named.\n"
            "   Qualifying trigger phrases (at least one MUST be present in Methods/Results):\n"
            "   • 'we measured', 'we quantified', 'we assayed', 'we determined', 'we performed [assay]'\n"
            "   • 'samples were analyzed using/by/with', 'samples were assayed by/using'\n"
            "   • 'concentrations were quantified/determined/measured by/using'\n"
            "   • 'plasma levels were determined/measured/quantified by/using'\n"
            "   • 'drug levels were measured/assayed/quantified using'\n"
            "   • 'the assay used was', 'the assay employed was', 'the assay performed was'\n"
            "   • '[assay name] was used to measure/quantify/determine [DOAC]'\n"
            "   • 'measurements were performed with/using', 'analyses were carried out using'\n"
            "   • A Methods subsection (e.g., 'Laboratory analysis', 'Sample analysis', 'DOAC level "
            "measurement', 'Anticoagulant assay') that names the assay used in THIS study.\n"
            "Step 2 (Map to label): ONLY after a qualifying Step-1 sentence is found, map the named "
            "technique to ALL matching Literal labels from the allowed list. Quote the trigger sentence "
            "in the companion sentence-from-text field.\n\n"
            "DO NOT INCLUDE based on:\n"
            "• Mentions of HPLC-MS, mass spectrometry, anti-Xa, dTT, ECT, ECA, or any other technique in "
            "Introduction, Background, Abstract, Discussion, References, or Acknowledgments. These are "
            "contextual mentions, NOT evidence the assay was used in this study.\n"
            "• Generic background statements such as 'HPLC-MS is the gold standard for DOAC quantification', "
            "'anti-Xa assays can measure DOACs', or 'mass spectrometry is widely used for DOAC measurement'.\n"
            "• Manufacturer/instrument names listed only as laboratory capabilities, equipment inventories, "
            "or available platforms WITHOUT explicit use on study samples.\n"
            "• Comparator/reference assays mentioned hypothetically (e.g., 'compared to mass spectrometry as "
            "the gold standard') without execution on patient-derived study samples.\n"
            "• Assays cited only via reference to a previous publication unless THIS paper also explicitly "
            "states the assay was performed on its own patient samples.\n\n"
    ...
    doac_level_measurement_descriptors: Optional[
        ...
        description=(
            "CRITICAL: Scan METHODS and RESULTS for assay terms. Return ALL assay descriptors that were "
            "ACTUALLY USED in THIS study to quantify DOAC levels (patient-derived sample measurements only). "
            "IGNORE Introduction, Background, Abstract, Discussion, References, Acknowledgments — these are "
            "contextual mentions and DO NOT qualify, even when a specific technique is named.\n\n"
            "REQUIRED TWO-STEP EVIDENCE GATE (MANDATORY):\n"
            "Step 1 (Locate trigger sentence): Find at least one sentence in METHODS or RESULTS that uses "
            "EXPLICIT performance language showing the assay was PERFORMED in THIS study on patient-derived "
            "samples. Qualifying trigger phrases (at least one MUST be present):\n"
            "   • 'we measured', 'we quantified', 'we assayed', 'we determined', 'we performed [assay]'\n"
            "   • 'samples were analyzed using/by/with', 'samples were assayed by/using'\n"
            "   • 'concentrations were quantified/determined/measured by/using'\n"
            "   • 'plasma levels were determined/measured/quantified by/using'\n"
            ...
            "measurement', 'Anticoagulant assay') that names the assay used in THIS study.\n"
            "Step 2 (Map to label): ONLY after a qualifying Step-1 sentence is found, map the named "
            "technique — including ALL synonyms, variants, and manufacturer/product names below — to ALL "
            "matching descriptor labels. Quote the trigger sentence in the companion sentence-from-text field.\n\n"
            "DO NOT INCLUDE based on:\n"
            "• Technique mentions in Introduction, Background, Abstract, Discussion, References, or "
            "Acknowledgments — contextual only.\n"
            "• Generic background claims (e.g., 'HPLC-MS is the gold standard', 'anti-Xa assays can quantify "
            "DOACs', 'various platforms exist for DOAC measurement').\n"
            "• Manufacturer/product names listed only as laboratory capabilities or equipment inventories "
            "WITHOUT explicit use on study samples.\n"
            "• Comparator/reference assays mentioned hypothetically without execution on this study's samples.\n"
            "• Assays cited only via reference to a previous publication unless THIS paper also explicitly "
            "states the assay was performed on its own patient samples.\n\n"
