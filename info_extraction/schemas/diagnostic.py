...
class ExtractionDiagnosticPerformance(BaseModel):
    ...
    diagnostic_performance_continuous: Optional[
        ...
        description=(
            ...
            "- NOTE: R² from a linear regression comparing a comparator assay to DOAC concentration IS valid evidence "
            "for 'R² (Coefficient of Determination)', even if the paper does not use the word 'correlation'.\n\n"
            "OUTPUT:\n"
    ...
    comparator_assays: Optional[
        ...
        description=(
            ...
            "NOTE: Linear regression r or R² comparing a comparator assay to DOAC concentration "
            "satisfies E2 even if the paper does not use the word 'correlation' or 'diagnostic performance'.\n\n"
