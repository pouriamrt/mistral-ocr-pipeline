...
class ExtractionPopulationIndications(BaseModel):
    ...
    indications_for_doac_level_measurement: Optional[
        ...
        description=(
            ...
            "Select the main category if the study fits the general description, or select a specific subcategory if applicable. "
            "If a subcategory fits the study, select only the most specific subcategory and do not select its main category. Only select the main category if no subcategory applies. Do not select both a main category and its subcategory for the same indication.\n\n"
            ...
            "2) Evaluate DOAC level exposure (main category)\n"
            ...
            "3) Identify predictors of DOAC level exposure (main category)\n"
            ...
            "4) Guide clinical decision-making (main category)\n"
            ...
            "5) Measure correlation with other laboratory techniques (main category)\n"
            ...
            "6) Risk prediction and clinical outcome association (main category)\n"
