...
class ExtractionDiagnosticPerformance(BaseModel):
    ...
    comparator_assays: Optional[
        ...
        description=(
            ...
            "Mentions in Abstract/Introduction/Methods/Discussion do NOT count as evidence, even if assays are listed there.\n\n"
            "TWO-STAGE, QUOTE-FIRST PROCEDURE (MANDATORY):\n"
            "Stage 1 (Evidence Harvest):\n"
            "  - Produce ≥1 EXACT verbatim quote per selected category.\n"
            "  - Each quote MUST come from an allowed Results source and MUST satisfy E1–E3.\n"
